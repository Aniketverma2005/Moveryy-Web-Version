...
import { MdArrowForward, MdArrowBack, MdCheckCircle, MdInfo, MdShield, MdFlashOn, MdOutlineGpsFixed } from 'react-icons/md';
    ...
    <div className="flex items-center gap-2">
        {[1, 2, 3].map((s, i) => (
            <div key={s} className="flex items-center gap-2">
                ...
                {i < 2 && (
                    <div className={`w-16 h-0.5 ${s < current ? 'bg-[#4285F4]' : 'bg-gray-200'}`} />
                )}
            </div>
        ))}
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <div className="flex-1 flex">
                ...
                {/* ── LEFT — Blue panel ──────────────────────────────── */}
                <div className="w-[480px] flex-shrink-0 bg-blue-600 relative overflow-hidden flex flex-col justify-between p-12">

                    {/* Background blobs */}
                    <div className="absolute inset-0 pointer-events-none overflow-hidden">
                        <div className="absolute -top-10 -right-10 w-60 h-60 rounded-full opacity-[0.12]"
                            style={{ background: 'radial-gradient(circle, #93c5fd, transparent)', animation: 'blob-float 10s ease-in-out infinite' }} />
                        <div className="absolute bottom-10 -left-8 w-44 h-44 rounded-full opacity-[0.08]"
                    ...
                    <div className="relative z-10">
                        <div className="bg-white rounded-xl p-2.5 inline-block shadow-md mb-8">
                            <img src={logo} alt="Moveryy" className="h-10 w-auto object-contain" />
                        </div>

                        {/* Dynamic heading */}
                        <h1 key={step} className="text-4xl font-extrabold text-white leading-tight mb-4 fade-up">
                            {panel.title}
                        </h1>
                        <p className="text-blue-100 text-base leading-relaxed mb-10 opacity-85 max-w-xs fade-up">
                            {panel.subtitle}
                        </p>
                        ...
                        <div className="space-y-4">
                            {panel.bullets.map((text) => (
                                <div key={text} className="flex items-center gap-3">
                                    <MdCheckCircle size={18} className="text-blue-300 flex-shrink-0" />
                    ...
                    {/* Footer */}
                    <p className="relative z-10 text-blue-300 text-xs opacity-60">
                    ...
                    <div className="w-full max-w-lg">
                        ...
                        {step === 1 && (
                            <div className="fade-up">
                                <h2 className="text-2xl font-bold text-gray-900 mb-1">Driver Information</h2>
                                <p className="text-gray-400 text-sm mb-8">Let's start with your basic information</p>
                        ...
                        {step === 2 && (
                            <div className="fade-up">
                                <h2 className="text-2xl font-bold text-gray-900 mb-1">License & ID Information</h2>
                                <p className="text-gray-400 text-sm mb-8">Please provide your driver's license and identification details</p>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <Field id="licenseExpiry" label="License Expiry Date" type="date" placeholder="dd/mm/yyyy" value={s2.licenseExpiry} onChange={h2} error={e2.licenseExpiry} />
                        ...
                        {step === 3 && (
                            <div className="fade-up">
                                <h2 className="text-2xl font-bold text-gray-900 mb-1">Address & Consent</h2>
                                <p className="text-gray-400 text-sm mb-8">Complete your profile and provide necessary consent</p>
                        ...
                        <div className="flex items-center justify-between mt-10 pt-6 border-t border-gray-100">
                            ...
                            <button
                                onClick={handleNext}
                                className="flex items-center gap-2 bg-[#4285F4] hover:bg-[#3367D6] text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors shadow-sm"
                            >
