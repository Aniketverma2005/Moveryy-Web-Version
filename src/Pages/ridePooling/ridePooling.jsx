import React from 'react'; // Explicitly importing React is good practice
...
const RidePooling = () => { // Capitalized name
            ...
            <nav className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-50">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        className="bg-[#4285F4] hover:bg-[#3367D6] text-white text-sm font-medium px-4 py-2 rounded-md shadow-sm transition-all active:scale-95"
                    >
                        Get Started
                    </button>
                </div>
                ...
                <div className="hidden lg:flex w-[450px] bg-[#4285F4] text-white p-12 flex-col justify-between">
                    <div>
                        <h1 className="text-4xl font-extrabold leading-tight mb-6">
                            Fast, Reliable Delivery Management
                        </h1>
                        <p className="text-lg opacity-85 mb-10">
                            Join the Moveryy network to streamline your logistics and maximize your daily earnings.
                        </p>
                ...
                <div className="flex-1 bg-gray-50 flex items-center justify-center p-6">
                    <div className="max-w-md w-full bg-white p-10 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <button
                            ...
                            className="w-full bg-[#4285F4] hover:bg-[#3367D6] text-white font-bold py-3.5 rounded-lg flex items-center justify-center gap-2 transition-all shadow-md mb-4"
                        >
