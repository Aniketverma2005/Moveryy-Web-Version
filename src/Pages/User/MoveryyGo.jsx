...
const MOCK_RIDES = [
  {
    ...
    passengers: [
      { name: 'Riya', avatar: 'R', color: 'bg-green-600' },
      { name: 'Karan', avatar: 'K', color: 'bg-blue-600' },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    passengers: [
      { name: 'Amit', avatar: 'A', color: 'bg-green-600' },
      { name: 'Sneha', avatar: 'S', color: 'bg-blue-600' },
    ],
  },
  {
    id: 4,
    ...
    amenities: ['AC'],
    passengers: [
      { name: 'Dev', avatar: 'D', color: 'bg-green-600' },
      { name: 'Pooja', avatar: 'P', color: 'bg-blue-600' },
    ],
  },
];
